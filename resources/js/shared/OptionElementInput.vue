  ...
  <section class="option-select-input-outer-wrapper">
    ...
    <div class="input-group">
      ...
      <div class="input-group-append">
        <AppButton btnType="button" btnStyle="secondary" :btnFunc="toggleOptionDiv">
          <i
            :class="
    ...
    >
      ...
      <ul v-if="arrType == 'obj'">
        <li
          ...
          :key="optionIndex"
          :class="
            option.name == optionElementData.optionSelected ? 'option-selected' : ''
          "
          @click="() => handleSelectedOptionClicked(option)"
        >
          {{ option.name }}
          <span v-show="countProperty != ''"> ({{ option[countProperty] }}) </span>
        </li>
      </ul>
