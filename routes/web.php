...
Route::match(['get', 'post'], '/blog/{action}/{slug}', [BlogController::class, 'index'])->name("blog.index");
...
Route::get('/admin/categories', [AdminCategoryController::class, 'index'])->name("admin.categoriesIndex")->middleware('isAdmin');
Route::post('/admin/update-category', [AdminCategoryController::class, 'update'])->name("admin.updateCategory")->middleware('isAdmin');
Route::post('/admin/delete-category', [AdminCategoryController::class, 'delete'])->name("admin.deleteCategory")->middleware('isAdmin');
Route::post('/admin/create-catgory', [AdminCategoryController::class, 'store'])->name("admin.createCategory")->middleware('isAdmin');
